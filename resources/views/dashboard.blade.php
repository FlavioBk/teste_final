          ...
          <div class="col-md-3 mb-4">
            <div class="card shadow-sm border-0">
              <div class="card-body text-center">
                <img class="rounded-circle mx-auto d-block mb-3 shadow" src="{{ asset($usuario->foto) }}" alt="Foto do usuário" width="100">
                <h5 class="card-title text-dark border-bottom pb-2">{{ $usuario->nome }}</h5>
